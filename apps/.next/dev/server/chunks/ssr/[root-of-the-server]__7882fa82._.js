...
var earth = {
    ...
    // subtle dark border
    borderFocus: oklch(palette.honeyYellow),
    // soft amber focus ring
    accent: oklch(palette.honeyYellow),
    // light honey amber (l:80, h:50)
    accentHover: oklch(palette.earthyOchre),
    // richer amber on hover (l:60, h:40)
    accentSubtle: "oklch(30% 0.08 48)",
    // dark honey tint for subtle surfaces
